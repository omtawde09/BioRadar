    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-center">
          {/* ══ LEFT COLUMN: 2 Cards (Slide in from Left with Scale Pop) ══ */}
          ...
          {/* ══ CENTER COLUMN: Large Kwala Wildlife Showcase with PopUp ══ */}
          ...
          {/* ══ RIGHT COLUMN: 2 Cards (Slide in from Right with Scale Pop) ══ */}
